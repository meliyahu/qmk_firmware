 ...
 * |--------+------+------+------+------+------| cmd  |           | Meh  |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  | tab one |           |      |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 ...
 *                                 `--------------------'       `----------------------'
 */
#define moshehErgodoxBase LAYOUT_ergodox( \
  /* left hand */ \
  KC_EQL,          KC_1,        KC_2,          KC_3,    KC_4,    KC_5,    KC_LEFT, \
  KC_DEL,          KC_Q,        KC_W,          KC_E,    KC_R,    KC_T,    TG(SYMB), \
  KC_BSPC,         KC_A,        KC_S,          KC_D,    KC_F,    KC_G, \
  KC_LSFT,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    CMDTAB, \
 ...
 *                                 `--------------------'       `--------------------'
 */
#define moshehErgodoxSymb LAYOUT_ergodox( \
  /* left hand */ \
 ...
 *                                 `--------------------'       `--------------------'
 */
#define moshehErgodoxMdia LAYOUT_ergodox( \
  /* left hand */ \
